...
That's it! Since the 1.2 version number in the controller file is greater than the 1.0 version stored against the package object in the database, Concrete5 will signal administrators that the package has an upgrade available.
