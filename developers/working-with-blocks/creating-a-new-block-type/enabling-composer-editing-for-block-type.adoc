...
image:block-type-enable-composer-editing-1.png[Listing the block in the page type edit interface.]

== HTML Block as It Appears in Composer

image:block-type-enable-composer-editing-2.png[The HTML block in the composer interface]
