...
What if a client wants to place a gallery of images from flickr.com on their page, or has a custom data feed that they want to display? These are situations in which developers will likely want to create their own custom block type.
