[[design_styles_less-and-bootstrap]]
= Advanced LESS Usage & Bootstrap

We've only scratched the surface of what's possible here.
Concrete5 ships with a full and complete LESS parser, meaning anything that LESS can do, Concrete5's style customizer can do.
You don't even have to use Concrete5's Style Customizer to make use of the LESS parser.
