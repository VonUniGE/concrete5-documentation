...
Why do you need to jump through these hoops to work with the physical file?
Why not just get the absolute path to the file?
Because in concrete5 there's no guarantee that the File object you're working with actually has a physical file present on the web server.
