...
When you're done editing themes, don't forget to turn these settings back on! Here is a little information about what the theme-specific cache settings actually do:
...
While working with themes it's generally a good idea to leave this off. Only turn it on when you're in production mode and you're not actively making changes.
